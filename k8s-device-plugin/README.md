...
```toml
[dependencies]
k8s-device-plugin = { version = "0.0.6", default-features = false, features = ["dra"] }
```
...
```toml
[dependencies]
k8s-device-plugin = { version = "0.0.6", default-features = false, features = ["dra", "resource-health"] }
```
